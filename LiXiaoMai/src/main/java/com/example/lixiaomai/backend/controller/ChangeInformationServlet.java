...
public class ChangeInformationServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (registerType.equals("customer")) {
            ...
            flag = customerService.updateCustomerInfo(customer.getId(), customer);
            ...
            flag = businessService.updateBusiness(business);
            ...
            flag = delivermanService.updateDelivermanInfo(deliverman.getId(), deliverman);
